...
class CameraTrafficLight {
  constructor(initObj={}) {
    if (initObj === null) {
      ...
      if (initObj.hasOwnProperty('light_shape')) {
        this.light_shape = initObj.light_shape
      }
      else {
        this.light_shape = 0;
      }
  ...
  static serialize(obj, buffer, bufferOffset) {
    ...
    bufferOffset = _serializer.uint8(obj.light_color, buffer, bufferOffset);
    // Serialize message field [light_shape]
    bufferOffset = _serializer.uint8(obj.light_shape, buffer, bufferOffset);
    return bufferOffset;
  }
  ...
  static deserialize(buffer, bufferOffset=[0]) {
    ...
    let len;
    let data = new CameraTrafficLight(null);
    ...
    data.light_color = _deserializer.uint8(buffer, bufferOffset);
    // Deserialize message field [light_shape]
    data.light_shape = _deserializer.uint8(buffer, bufferOffset);
    return data;
  }
  ...
  static Resolve(msg) {
    ...
    const resolved = new CameraTrafficLight(null);
    ...
    if (msg.light_shape !== undefined) {
      resolved.light_shape = msg.light_shape;
    }
    else {
      resolved.light_shape = 0
    }
...
module.exports = CameraTrafficLight;
