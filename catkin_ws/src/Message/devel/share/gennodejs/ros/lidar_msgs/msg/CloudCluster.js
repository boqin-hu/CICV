...
class CloudCluster {
  constructor(initObj={}) {
    if (initObj === null) {
      ...
      if (initObj.hasOwnProperty('is_obj')) {
        this.is_obj = initObj.is_obj
      }
      else {
        this.is_obj = false;
      }
  ...
  static serialize(obj, buffer, bufferOffset) {
    ...
    // Serialize message field [is_obj]
    bufferOffset = _serializer.bool(obj.is_obj, buffer, bufferOffset);
  ...
  static deserialize(buffer, bufferOffset=[0]) {
    ...
    // Deserialize message field [is_obj]
    data.is_obj = _deserializer.bool(buffer, bufferOffset);
  ...
  static datatype() {
    ...
    return 'lidar_msgs/CloudCluster';
  }

  static md5sum() {
    //Returns md5sum for a message object
    return '071698e274b553b80f797bcbb858fd9e';
  }
  ...
  static Resolve(msg) {
    ...
    if (msg.is_obj !== undefined) {
      resolved.is_obj = msg.is_obj;
    }
    else {
      resolved.is_obj = false
    }
