...
(cl:defclass <MarkerArray> (roslisp-msg-protocol:ros-message)
  ((markers
    :reader markers
    :initarg :markers
    :type (cl:vector common_msgs-msg:Marker)
   :initform (cl:make-array 0 :element-type 'common_msgs-msg:Marker :initial-element (cl:make-instance 'common_msgs-msg:Marker))))
)
...
(cl:defmethod cl:initialize-instance :after ((m <MarkerArray>) cl:&rest args)
  ...
  (cl:unless (cl:typep m 'MarkerArray)
    (roslisp-msg-protocol:msg-deprecation-warning "using old message class name common_msgs-msg:<MarkerArray> is deprecated: use common_msgs-msg:MarkerArray instead.")))

(cl:ensure-generic-function 'markers-val :lambda-list '(m))
(cl:defmethod markers-val ((m <MarkerArray>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader common_msgs-msg:markers-val is deprecated.  Use common_msgs-msg:markers instead.")
  (markers m))
...
(cl:defmethod roslisp-msg-protocol:deserialize ((msg <MarkerArray>) istream)
  ...
  (cl:let ((vals (cl:slot-value msg 'markers)))
    ...
    (cl:setf (cl:aref vals i) (cl:make-instance 'common_msgs-msg:Marker))
