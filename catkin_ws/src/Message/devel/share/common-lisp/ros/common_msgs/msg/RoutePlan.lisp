...
(cl:defclass <RoutePlan> (roslisp-msg-protocol:ros-message)
  ((header
   ...
   (point
    :reader point
    :initarg :point
    :type common_msgs-msg:MissionPoint
    :initform (cl:make-instance 'common_msgs-msg:MissionPoint))
   (global_road
    :reader global_road
    :initarg :global_road
...
(cl:defmethod cl:initialize-instance :after ((m <RoutePlan>) cl:&rest args)
  ...
  (cl:unless (cl:typep m 'RoutePlan)
    (roslisp-msg-protocol:msg-deprecation-warning "using old message class name common_msgs-msg:<RoutePlan> is deprecated: use common_msgs-msg:RoutePlan instead.")))
...
(cl:defmethod point-val ((m <RoutePlan>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader common_msgs-msg:point-val is deprecated.  Use common_msgs-msg:point instead.")
  (point m))

(cl:ensure-generic-function 'global_road-val :lambda-list '(m))
(cl:defmethod global_road-val ((m <RoutePlan>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader common_msgs-msg:global_road-val is deprecated.  Use common_msgs-msg:global_road instead.")
  (global_road m))
