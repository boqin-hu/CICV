...
(cl:defmethod roslisp-msg-protocol:md5sum ((type (cl:eql '<SingleTrafficLight>)))
  ...
  "881071b86c0a28ec94db50b4995ef6c8")
(cl:defmethod roslisp-msg-protocol:md5sum ((type (cl:eql 'SingleTrafficLight)))
  "Returns md5sum for a message object of type 'SingleTrafficLight"
  "881071b86c0a28ec94db50b4995ef6c8")
(cl:defmethod roslisp-msg-protocol:message-definition ((type (cl:eql '<SingleTrafficLight>)))
  ...
  (cl:format cl:nil "int8 color #UNKNOWN_COLOR = 0; RED = 1; YELLOW = 2; GREEN = 3; BLACK = 4;~%string id # Traffic light string-ID in the map data.~%float32 confidence  #How confidence about the detected results, between 0 and 1.~%float32 tracking_time  # Duration of the traffic light since detected.~%~%~%"))
(cl:defmethod roslisp-msg-protocol:message-definition ((type (cl:eql 'SingleTrafficLight)))
  "Returns full string definition for message of type 'SingleTrafficLight"
  (cl:format cl:nil "int8 color #UNKNOWN_COLOR = 0; RED = 1; YELLOW = 2; GREEN = 3; BLACK = 4;~%string id # Traffic light string-ID in the map data.~%float32 confidence  #How confidence about the detected results, between 0 and 1.~%float32 tracking_time  # Duration of the traffic light since detected.~%~%~%"))
