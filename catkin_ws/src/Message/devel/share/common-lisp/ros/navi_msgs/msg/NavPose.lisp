...
(cl:defmethod cl:initialize-instance :after ((m <NavPose>) cl:&rest args)
  ...
  (cl:unless (cl:typep m 'NavPose)
    (roslisp-msg-protocol:msg-deprecation-warning "using old message class name navi_msgs-msg:<NavPose> is deprecated: use navi_msgs-msg:NavPose instead.")))
...
(cl:defmethod yaw-val ((m <NavPose>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader navi_msgs-msg:yaw-val is deprecated.  Use navi_msgs-msg:yaw instead.")
  (yaw m))
