...
(cl:defmethod cl:initialize-instance :after ((m <Centroids>) cl:&rest args)
  ...
  (cl:unless (cl:typep m 'Centroids)
    (roslisp-msg-protocol:msg-deprecation-warning "using old message class name lidar_msgs-msg:<Centroids> is deprecated: use lidar_msgs-msg:Centroids instead.")))
