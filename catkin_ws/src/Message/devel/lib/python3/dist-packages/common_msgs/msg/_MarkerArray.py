...
"""autogenerated by genpy from common_msgs/MarkerArray.msg. Do not edit."""
import codecs
import sys
...
"""
  __slots__ = ['markers']
  _slot_types = ['common_msgs/Marker[]']
