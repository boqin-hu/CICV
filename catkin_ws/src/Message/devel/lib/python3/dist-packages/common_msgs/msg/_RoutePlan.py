...
"""autogenerated by genpy from common_msgs/RoutePlan.msg. Do not edit."""
import codecs
import sys
...
class RoutePlan(genpy.Message):
  _md5sum = "588f95e3e5ed3efb7cc8dd4fbc6621ba"
  _type = "common_msgs/RoutePlan"
...
float64 heading"""
  ...
  _slot_types = ['std_msgs/Header','int32','int32','common_msgs/MissionPoint','string[]','float64']
  ...
  def __init__(self, *args, **kwds):
    ...
    if args or kwds:
      ...
      if self.point is None:
        self.point = common_msgs.msg.MissionPoint()
  ...
  def serialize(self, buff):
    ...
    try:
      ...
      _x = self
      buff.write(_get_struct_2i3d().pack(_x.id, _x.result, _x.point.xg, _x.point.yg, _x.point.heading))
  ...
  def deserialize(self, str):
    ...
    try:
      ...
      (_x.id, _x.result, _x.point.xg, _x.point.yg, _x.point.heading,) = _get_struct_2i3d().unpack(str[start:end])
      start = end
      end += 4
      (length,) = _struct_I.unpack(str[start:end])
      self.global_road = []
