...
"""autogenerated by genpy from lidar_msgs/CloudCluster.msg. Do not edit."""
import codecs
import sys
...
class CloudCluster(genpy.Message):
  _md5sum = "071698e274b553b80f797bcbb858fd9e"
  _type = "lidar_msgs/CloudCluster"
...
uint32 stride  # stride of given dimension"""
  __slots__ = ['header','is_obj','id','label','score','cloud','cells','convex_hull','pose','dimensions','estimated_angle','min_point','max_point','avg_point','centroid_point','eigen_values','eigen_vectors','fpfh_descriptor','indicator_state']
  _slot_types = ['std_msgs/Header','bool','uint32','string','float64','sensor_msgs/PointCloud2','perception_msgs/ObstacleCell[]','geometry_msgs/PolygonStamped','geometry_msgs/Pose','geometry_msgs/Vector3','float64','geometry_msgs/PointStamped','geometry_msgs/PointStamped','geometry_msgs/PointStamped','geometry_msgs/PointStamped','geometry_msgs/Vector3','geometry_msgs/Vector3[]','std_msgs/Float32MultiArray','uint32']
  ...
  def __init__(self, *args, **kwds):
    ...
    The available fields are:
       header,is_obj,id,label,score,cloud,cells,convex_hull,pose,dimensions,estimated_angle,min_point,max_point,avg_point,centroid_point,eigen_values,eigen_vectors,fpfh_descriptor,indicator_state
  ...
  def serialize(self, buff):
    ...
    try:
      ...
      _x = self
      buff.write(_get_struct_11d3I().pack(_x.pose.position.x, _x.pose.position.y, _x.pose.position.z, _x.pose.orientation.x, _x.pose.orientation.y, _x.pose.orientation.z, _x.pose.orientation.w, _x.dimensions.x, _x.dimensions.y, _x.dimensions.z, _x.estimated_angle, _x.min_point.header.seq, _x.min_point.header.stamp.secs, _x.min_point.header.stamp.nsecs))
      ...
      buff.write(struct.Struct('<I%ss'%length).pack(length, _x))
      _x = self
      buff.write(_get_struct_6d().pack(_x.centroid_point.point.x, _x.centroid_point.point.y, _x.centroid_point.point.z, _x.eigen_values.x, _x.eigen_values.y, _x.eigen_values.z))
  ...
  def deserialize(self, str):
    ...
    try:
      ...
      (_x.pose.position.x, _x.pose.position.y, _x.pose.position.z, _x.pose.orientation.x, _x.pose.orientation.y, _x.pose.orientation.z, _x.pose.orientation.w, _x.dimensions.x, _x.dimensions.y, _x.dimensions.z, _x.estimated_angle, _x.min_point.header.seq, _x.min_point.header.stamp.secs, _x.min_point.header.stamp.nsecs,) = _get_struct_11d3I().unpack(str[start:end])
      start = end
      end += 4
      (length,) = _struct_I.unpack(str[start:end])
      start = end
      ...
      (_x.centroid_point.point.x, _x.centroid_point.point.y, _x.centroid_point.point.z, _x.eigen_values.x, _x.eigen_values.y, _x.eigen_values.z,) = _get_struct_6d().unpack(str[start:end])
      start = end
      end += 4
      (length,) = _struct_I.unpack(str[start:end])
      self.eigen_vectors = []
