// Generated by gencpp from file common_msgs/Marker.msg
// DO NOT EDIT!


#ifndef COMMON_MSGS_MESSAGE_MARKER_H
#define COMMON_MSGS_MESSAGE_MARKER_H
...
// reducing the odds to have name collisions with Windows.h 
  ...
  typedef boost::shared_ptr< ::common_msgs::Marker_<ContainerAllocator> > Ptr;
  typedef boost::shared_ptr< ::common_msgs::Marker_<ContainerAllocator> const> ConstPtr;

}; // struct Marker_

typedef ::common_msgs::Marker_<std::allocator<void> > Marker;

typedef boost::shared_ptr< ::common_msgs::Marker > MarkerPtr;
typedef boost::shared_ptr< ::common_msgs::Marker const> MarkerConstPtr;
...
std::ostream& operator<<(std::ostream& s, const ::common_msgs::Marker_<ContainerAllocator> & v)
{
ros::message_operations::Printer< ::common_msgs::Marker_<ContainerAllocator> >::stream(s, "", v);
return s;
}


template<typename ContainerAllocator1, typename ContainerAllocator2>
bool operator==(const ::common_msgs::Marker_<ContainerAllocator1> & lhs, const ::common_msgs::Marker_<ContainerAllocator2> & rhs)
{
...
template <class ContainerAllocator>
struct IsMessage< ::common_msgs::Marker_<ContainerAllocator> >
  : TrueType
  { };

template <class ContainerAllocator>
struct IsMessage< ::common_msgs::Marker_<ContainerAllocator> const>
  : TrueType
  { };

template <class ContainerAllocator>
struct IsFixedSize< ::common_msgs::Marker_<ContainerAllocator> >
  : FalseType
  { };

template <class ContainerAllocator>
struct IsFixedSize< ::common_msgs::Marker_<ContainerAllocator> const>
  : FalseType
  { };

template <class ContainerAllocator>
struct HasHeader< ::common_msgs::Marker_<ContainerAllocator> >
  : TrueType
  { };

template <class ContainerAllocator>
struct HasHeader< ::common_msgs::Marker_<ContainerAllocator> const>
  : TrueType
  { };


template<class ContainerAllocator>
struct MD5Sum< ::common_msgs::Marker_<ContainerAllocator> >
{
  ...
  static const char* value(const ::common_msgs::Marker_<ContainerAllocator>&) { return value(); }
  static const uint64_t static_value1 = 0x18326976df9d2924ULL;
  static const uint64_t static_value2 = 0x9efc939e00342cdeULL;
};

template<class ContainerAllocator>
struct DataType< ::common_msgs::Marker_<ContainerAllocator> >
{
  static const char* value()
  {
...
template<class ContainerAllocator>
struct Definition< ::common_msgs::Marker_<ContainerAllocator> >
{
  static const char* value()
  {
...
namespace serialization
{
  ...
  template<class ContainerAllocator> struct Serializer< ::common_msgs::Marker_<ContainerAllocator> >
  {
...
template<class ContainerAllocator>
struct Printer< ::common_msgs::Marker_<ContainerAllocator> >
{
  template<typename Stream> static void stream(Stream& s, const std::string& indent, const ::common_msgs::Marker_<ContainerAllocator>& v)
  {
    s << indent << "header: ";
    s << std::endl;
...
#endif // COMMON_MSGS_MESSAGE_MARKER_H
