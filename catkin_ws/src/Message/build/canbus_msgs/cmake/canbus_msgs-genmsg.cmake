...
message(STATUS "canbus_msgs: 1 messages, 0 services")

set(MSG_I_FLAGS "-Icanbus_msgs:/home/cicv/Message/src/canbus_msgs/msg;-Istd_msgs:/opt/ros/noetic/share/std_msgs/cmake/../msg")
...
get_filename_component(_filename "/home/cicv/Message/src/canbus_msgs/msg/CanFault.msg" NAME_WE)
add_custom_target(_canbus_msgs_generate_messages_check_deps_${_filename}
  COMMAND ${CATKIN_ENV} ${PYTHON_EXECUTABLE} ${GENMSG_CHECK_DEPS_SCRIPT} "canbus_msgs" "/home/cicv/Message/src/canbus_msgs/msg/CanFault.msg" ""
)
...
_generate_msg_cpp(canbus_msgs
  "/home/cicv/Message/src/canbus_msgs/msg/CanFault.msg"
  "${MSG_I_FLAGS}"
  ""
...
if(genpy_INSTALL_DIR AND EXISTS ${CATKIN_DEVEL_PREFIX}/${genpy_INSTALL_DIR}/canbus_msgs)
  install(CODE "execute_process(COMMAND \"/usr/bin/python3\" -m compileall \"${CATKIN_DEVEL_PREFIX}/${genpy_INSTALL_DIR}/canbus_msgs\")")
  # install generated code
  install(
